                          ...
                          const Vector3f& dir, float& tnear, float& u, float& v)
{
    ...
    Vector3f S = orig - v0, E1 = v1 - v0, E2 = v2 - v0;
    Vector3f S2 = crossProduct(S, E1), S1 = crossProduct(dir, E2);
    float coeff = 1 / dotProduct(S1, E1);
...
inline Intersection Triangle::getIntersection(Ray ray)
{
    ...
    Vector3f S = ray.origin - v0, E1 = v1 - v0, E2 = v2 - v0;
    Vector3f S2 = crossProduct(S, E1), S1 = crossProduct(ray.direction, E2);
    float coeff = 1 / dotProduct(S1, E1);
    float t = coeff * dotProduct(S2, E2);
